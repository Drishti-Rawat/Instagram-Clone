...
function Sidebar() {
  ...
  return (
    <>
      <section className="flex flex-col gap-5  text-black border-r-2  px-5 fixed">
        <Link to="/Home">
        ...
        <div className="flex flex-col gap-2 py-2  px-1">
          <Link to="/Home">
            <div className="flex justify-start items-center gap-2 py-3 pr-32 pl-1 hover:bg-zinc-200  rounded-lg">
              <svg
          ...
          <div onClick={openCreate} className=" flex items-center gap-2 py-3 pl-1 hover:bg-zinc-200 rounded-lg cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="30"
              height="20"
            ...
            >
              ...
              {isCreateopen && <Create onClose={closeCreate} />}
          ...
          <Link to="/Profile">
            {" "}
            <div className=" flex items-center gap-2 py-2 pl-1 hover:bg-zinc-200  rounded-lg">
